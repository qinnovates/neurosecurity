 ...
 *   docs/data/kql-tables.json         — all tables EXCEPT impact_chains (~800KB)
 *   docs/data/kql-impact-chains.json  — impact_chains only (~2.1MB, lazy-loaded)
 *
...
async function main() {
  const outDir = resolve(ROOT, 'docs/data');
