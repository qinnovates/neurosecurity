...
**Cs (Coherence Score)** is a neurosecurity scoring metric. Validation was conducted on synthetic EEG signals generated by the BrainFlow SDK (a standard BCI development library). No real human EEG data and no human subjects were involved.

**What exists today:**
- A published threat taxonomy (109 techniques, open-source)
- A scoring system (NISS v1.1, tested on synthetic EEG data)
