...
I've been building on the web since I was 12. In the early 2000s, the internet was going through a pivotal transition — from chaotic, animated GeoCities-style pages to structured, semi-professional layouts for forums and portals. I co-founded a design studio called **AGFX** (Aaron's Graphics) with my friend Aaron White, and we were at the forefront of that shift. We were part of the first generation of digital natives who proved that high-level technical collaboration didn't require a physical office — we built AGFX through IRC, AIM, and the Envisionboard (InvisionFree) support forums we managed.

AGFX operated through agfx.com and agfx.net, specializing in customizing the two dominant forum platforms of the era: **phpBB** (particularly 2.0.x) and **Invision Power Board** (IPB). Between 2002 and 2005, these platforms powered thousands of gaming clans, tech communities, hobbyist forums, and early startups. AGFX became known for elevating their default themes into polished, high-end visual systems — we were table-hacking and manually slicing Photoshop CS files to create skins like SubMerged, Aeolus, and Chronicles that reached over 100,000 downloads and defined the "Tactical-Tech" aesthetic. While Aaron eventually went to Auburn University to formalize his design education, the middle school era of AGFX was where the raw innovation happened.

Our AGFX support forum wasn't just a download portal — it was a mentorship hub where we provided real-time technical support to thousands of users, one of the first "Design-as-a-Service" communities. We published Photoshop tutorials that ranked in the Top 100 on major aggregator sites like Good-Tutorials.com and Pixel2Life, teaching design to a global audience before YouTube or DeviantArt existed. We were front-end engineers before that was a job title — hacking HTML tables and CSS on platforms like InvisionFree that gave us no server access, building fluid layouts that worked across IE6, Netscape, and early Firefox. The history of AGFX is documented through archived listings on early-2000s resource hubs like phpBB Styles, historical snapshots on the Wayback Machine (agfx.net, 2002-2005), and community directories like Pixel2Life and Good-Tutorials.

The ethical instinct and technical curiosity I developed managing a global community at age 12 directly shaped my 15-year career in cybersecurity — from architecting Splunk for 75M+ users at Tinder/Match Group to my current research into neurosecurity and the [Quantified Interconnection Framework](https://qinnovate.com/whitepaper/). Aaron similarly translated those early skills into a career in product operations and design leadership.

That same instinct — build something, teach others, grow a community — has repeated at every stage of my career.
