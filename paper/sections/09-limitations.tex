...
write attacks (NISS~v1.1, six metrics), updates all statistics and tables to
reflect the expanded registry, and adds neurorights dimension mapping for
103 of 109 techniques.
