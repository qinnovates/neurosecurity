...
11-band hourglass architecture, a 109-technique threat taxonomy (TARA), a
CVSS v4.0 extension for neural-specific scoring (NISS with six metrics), and the
Neural Impact Chain---a first-of-its-kind methodology for mapping security
vulnerabilities to DSM-5-TR psychiatric diagnoses. Analysis of all 109 techniques
reveals that 99.1\% require scoring dimensions CVSS cannot express, 71.6\% have
therapeutic dual-use analogs, and 56.0\% pose direct or indirect psychiatric
diagnostic risk.
