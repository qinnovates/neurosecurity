...
1. **Consent Is Architecture, Not Policy** -- cryptographic gate in the data pipeline, not a checkbox
2. **Human-in-the-Loop Is Non-Negotiable** -- awareness + ability + accountability (de Sio & van den Hoven, 2018)
3. **AI Self-Preservation to Protect Users** -- tamper resistance, graceful degradation, continuity of protection
4. **Neural Data Is Not Just Data** -- highest protection tier, cannot be changed, much is involuntary
5. **Defensive Framing Only** -- detect threats, never exploit them; security framing paired with governance
