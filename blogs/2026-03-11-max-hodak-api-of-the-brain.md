...
Science Corp's retinal prosthesis bypasses the dead rods and cones to stimulate the bipolar cells directly -- upstream of the compression layer. In the [PRIMAvera pivotal trial](https://clinicaltrials.gov/study/NCT04676854) (38 patients), the mean improvement was [23 letters of visual acuity](https://science.xyz/news/primavera-trial-preliminary-results/), with the best patient gaining 59 letters. This dramatically outperformed Second Sight's Argus II, which stimulated the ganglion cells downstream of the compression and [produced limited real-world utility](https://pubmed.ncbi.nlm.nih.gov/22244176/) -- and eventually [left 350+ patients with obsolete, unsupported devices](https://spectrum.ieee.org/bionic-eye-obsolete).
...
This is the computer-per-nerves framing. The brain is not a black box -- it is a layered signal processing system, and each layer has [discoverable input/output characteristics](https://pmc.ncbi.nlm.nih.gov/articles/PMC8286913/). Neurons fire, signals propagate, representations form. Recent work has demonstrated this concretely: a Stanford team [decoded speech at 62 words per minute](https://www.nature.com/articles/s41586-023-06377-x) from intracortical recordings, while Neuralink's [PRIME study](https://neuralink.com/updates/prime-study-progress-update/) achieved wireless motor decoding at [8.0 bits/second](https://neuralink.com/updates/prime-study-progress-update-user-experience/) in their first human participant. The engineering challenge is getting the right signals into the right layer at the right resolution.
...
This is not speculative. A [systematic review of 35 human transcranial focused ultrasound studies](https://pubmed.ncbi.nlm.nih.gov/35533835/) (677 subjects) found dose-dependent cognitive and mood effects with no severe adverse events. A controlled study showed [30 seconds of tFUS to the right prefrontal cortex produced mood improvement lasting 30+ minutes](https://pmc.ncbi.nlm.nih.gov/articles/PMC7058635/) and measurably altered resting-state fMRI connectivity. The mechanism works. [TMS has already been studied extensively for cognitive enhancement](https://pmc.ncbi.nlm.nih.gov/articles/PMC6401552/) in both clinical and healthy populations.

This is exactly the dual-use boundary that QIF's clinical [TARA mappings](/atlas/tara/) exist to describe. The proposed TARA catalog maps [109 threat techniques](/atlas/tara/ttps/) across [7 neural band regions](/framework/) (N1-N7). Many of those techniques describe the same physical mechanisms Hodak is proposing for therapeutic use -- amplitude modulation, frequency-targeted stimulation, signal injection at specific cortical regions. Tennison and Moreno established this dual-use framework for neuroscience in [a foundational 2012 paper](https://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.1001289): the same neural interface technologies that restore function can be turned to surveillance, coercion, or cognitive manipulation.

The difference between a digital Adderall and a neural attack is not the physics. It is consent, dosage calibration, and oversight. QIF's proposed [framework](/framework/) maps both sides of that boundary because the signal-level mechanisms are identical. The [therapeutic overlap analysis](/atlas/therapeutics/) maps this dual-use boundary explicitly. Researchers building adaptive deep brain stimulators have [raised the same concern](https://pmc.ncbi.nlm.nih.gov/articles/PMC9050172/): closed-loop stimulators that read and write to neural circuits can modulate mood, cognition, and impulse control beyond therapeutic intent.
...
Hodak's [bio-hybrid neural interfaces program](https://science.xyz/news/biohybrid-neural-interfaces/) is building probes that grow into the brain using living neurons. Their [preclinical results](https://www.biorxiv.org/content/10.1101/2024.11.22.624907v1) showed engrafted optogenetically-enabled neurons survived, integrated with host brain tissue, and transmitted information enabling goal-directed behavior in mice. The pitch: biological integration eliminates the [foreign-body immune response](https://pmc.ncbi.nlm.nih.gov/articles/PMC10720954/) that degrades conventional electrodes over time. A [2025 Nature Communications review](https://www.nature.com/articles/s41467-025-57016-0) maps the emerging class of "living" neural interfaces that incorporate biological cells into the device structure itself.

The security implication: a bio-hybrid implant cannot be removed without destroying the neural tissue it has integrated with. Every conventional BCI at least has a theoretical extraction path. Bio-hybrid interfaces are permanent by design. Hodak himself wrote about this boundary [as early as 2016](https://maxhodak.com/writings/2016/03/30/where-is-the-border): at sufficient bandwidth, "the border around a brain" becomes ambiguous. In a [December 2025 TechCrunch feature](https://techcrunch.com/2025/12/05/after-neuralink-max-hodak-is-building-something-stranger/), he put it more directly: "You could really, in a very fundamental sense, talk about redrawing the border around a brain, possibly to include four hemispheres, or a device, or a whole group of people."
...
Hodak [explicitly downplays BCI security risks](https://techcrunch.com/podcast/max-hodak-is-more-worried-about-twitter-than-brain-computer-interface-hacking/): he is more concerned about social media's influence on cognition than about someone hacking a brain implant. His reasoning -- current BCIs have limited bandwidth, physical access requirements, and the attack surface is small compared to the information firehose people voluntarily consume.
...
He is wrong about the trajectory. The entire interview is a roadmap for making BCIs higher-bandwidth, less invasive (ultrasound), consumer-facing (digital Adderall), and permanently integrated (bio-hybrid). Every advance he describes expands the attack surface he dismisses. The security research community has already mapped this surface: [Denning, Matsuoka, and Kohno defined neurosecurity](https://thejns.org/focus/view/journals/neurosurg-focus/27/1/2009.4.focus0985.xml) in 2009. [Pycroft et al. cataloged brainjacking attacks](https://pubmed.ncbi.nlm.nih.gov/27184896/) against implanted stimulators in 2016. [Ienca and Haselager](https://link.springer.com/article/10.1007/s10676-016-9398-9) framed neurocrime as an extension of cybercrime to neural devices that same year. A [2021 ACM survey](https://dl.acm.org/doi/abs/10.1145/3427376) mapped the full BCI lifecycle attack taxonomy. And [Meng et al. demonstrated in 2023](https://pubmed.ncbi.nlm.nih.gov/37145943/) that EEG-based BCIs are vulnerable to backdoor attacks via narrow-period pulse injection into training data.
...
Every tool, dataset, and mapping is [open source](https://github.com/qinnovates/qinnovate). Every AI contribution is [documented](/governance/). Every claim is classified by evidence level and held to [neuromodesty constraints](/research/validation/) -- because the field does not need more hype. It needs engineering.
