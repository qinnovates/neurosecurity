...
> **Purpose:** This document serves as the scientific and mathematical deep-dive companion to the [QIF Whitepaper v8.0](https://github.com/qinnovates/neurosecurity/blob/main/osi-of-mind/whitepapers/QIF-WHITEPAPER-V8.md). It preserves the full derivation context, formulas, and validation roadmap for all quantitative claims. The whitepaper references this document for detailed scientific and mathematical treatment.
...
NISS is a **proposed, unvalidated** scoring system. It has not been independently peer-reviewed or adopted by any standards body. The author was invited by FIRST.org to contribute to the CVSS Resources ecosystem but is deliberately declining until at least one independent researcher has reviewed the scoring methodology, attempted to break it, and either confirmed its soundness or identified corrections. See [QIF Whitepaper v8.0](https://github.com/qinnovates/neurosecurity/blob/main/osi-of-mind/whitepapers/QIF-WHITEPAPER-V8.md), Section 19.1 for the full validation roadmap.
...
> **Note:** This section reflects the validation roadmap as of v8.0 (March 2026). Items marked DONE have been completed since v7.0. For the full, current validation roadmap, see [QIF Whitepaper v8.0](https://github.com/qinnovates/neurosecurity/blob/main/osi-of-mind/whitepapers/QIF-WHITEPAPER-V8.md), Section 10 (Future Work) and Section 19 (Research Validation).
