---
title: "Project Update: 2026-03-05"
...
tags: ["#Changelog","#Release","#Validation"]
author: "Kevin Qi"
fact_checked: false
fact_check_date: ""
fact_check_notes: []
...
- **Add BrainFlow data source disclaimer to validation page** ([7861307](https://github.com/qinnovates/neurosecurity/commit/7861307))
  acquisition via BrainFlow API, data format (2D NumPy array in µV),
