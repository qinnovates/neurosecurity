...
The gap is not theoretical: our analysis of 109 BCI attack techniques shows that
99.1\% require scoring dimensions that CVSS cannot express.
...
\begin{enumerate}
  ...
  \item \textbf{TARA Threat Taxonomy} (Section~\ref{sec:tara}): A registry of
        109~techniques across 15~tactics and 8~domains, each classified by
