...
\begin{table}[H]
\centering
\caption{Consent tier classification across 109 techniques.}
\label{tab:consent}
\small
\begin{tabular}{@{}l l l@{}}
\toprule
...
Privacy                        & Principle & Implemented & Cognitive reconnaissance (CR) / disruption (CD) metrics \\
...
\begin{enumerate}
  \item \textbf{Cognitive Liberty}: Captured by the consent violation metric (CV).
        ...
        Partial.
  \item \textbf{Mental Privacy}: Captured by the cognitive reconnaissance metric (CR).
