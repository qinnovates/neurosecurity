...
\begin{itemize}
  ...
  \item \textbf{CR/CD-driven} $\to$ Cognitive/Psychotic cluster: cognitive
        reconnaissance or disruption implies perceptual or thought-process compromise
...
All 109 TARA techniques have been mapped through the NIC pipeline:

\begin{table}[H]
\centering
\caption{Neural Impact Chain mapping results across 109 techniques.}
\label{tab:nic-stats}
\small
\begin{tabular}{@{}l r@{}}
\toprule
...
\midrule
Techniques mapped                 & 103 / 109 (94.5\%) \\
Unique DSM-5-TR codes             & 29 \\
Diagnostic clusters               & 5 \\
Direct diagnostic risk             & 52 (47.7\%) \\
Indirect diagnostic risk           & 9 (8.3\%) \\
No diagnostic risk (silicon-only)  & 42 (38.5\%) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
  \item \textbf{Direct} (52 techniques, 47.7\%): The attack mechanism can
        ...
        diagnostic codes.
  \item \textbf{Indirect} (9 techniques, 8.3\%): The attack creates downstream
...
\begin{enumerate}
  ...
  \item \textbf{Function}: Motor control, executive function, memory
        consolidation
  \item \textbf{NISS}: BI:C / CR:H / CD:H / CV:I / RV:P / NP:S $\to$ Score: 8.7
        (High), PINS flagged
...
\begin{figure}[H]
  ...
  \caption{DSM-5-TR cluster distribution across 109 TARA techniques. 61
  techniques (56.0\%) have direct or indirect diagnostic risk.}
