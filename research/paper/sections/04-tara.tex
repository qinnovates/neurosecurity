...
The TARA registry organizes 109 techniques into 15 tactics across 8 operational
...
Demonstrated & Proven in laboratory or controlled conditions            & 35 \\
Emerging     & Newly identified; limited but growing evidence           & 22 \\
Theoretical  & Plausible based on known physics and engineering          & 31 \\
...
CVSS v4.0 base severity ratings for all 109 techniques show a distribution
...
The 109 techniques distribute across eight operational categories:
...
\begin{table}[H]
\centering
\caption{Dual-use classification of 109 TARA techniques.}
\label{tab:dualuse}
\small
...
Of the 109 techniques, 78 (71.6\%) have confirmed, probable, or possible therapeutic analogs.
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{TARA severity distribution across 109 techniques.}
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{Dual-use classification: 71.6\% of techniques have therapeutic analogs.}
