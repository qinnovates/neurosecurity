...
(2)~\textbf{TARA}, a threat taxonomy of 109 techniques across 15 tactics and 8 domains, each
classified by status, severity, and dual-use therapeutic potential;
(3)~\textbf{NISS}, the Neural Impact Scoring System---a CVSS v4.0 extension adding six
neural-specific metrics (Biological Impact, Cognitive Reconnaissance, Cognitive Disruption, Consent Violation,
...
Analysis of all 109 techniques reveals that 99.1% require NISS extension metrics that CVSS
cannot express. The Neural Impact Chain maps all techniques to 29 unique DSM-5-TR diagnostic
codes across 5 psychiatric clusters, with 52 techniques posing direct diagnostic risk. The
framework identifies 78 techniques (71.6%) with confirmed, probable, or possible therapeutic analogs,
