...
const blog = defineCollection({
  loader: glob({ pattern: ['**/*.md', '!**/README.md', '!**/CLAUDE.md', '!**/AGENTS.md', '!**/CONTEXT.md'], base: './research/blog' }),
  schema: z.object({
    title: z.string(),
...
const governance = defineCollection({
  loader: glob({ pattern: ['DECISION-LOG.md', 'TRANSPARENCY.md', 'SHIP-LOG.md'], base: './governance' }),
  schema: z.object({
    title: z.string(),
...
const research = defineCollection({
  loader: glob({ pattern: ['*.md', 'techniques/**/*.md', '!README.md', '!CONTEXT.md'], base: './research' }),
  schema: z.object({
    title: z.string(),
