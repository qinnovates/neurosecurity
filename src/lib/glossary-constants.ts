...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    fullDef: 'Maps NISS metrics to diagnostic risk domains: BI (Biological Impact) \u2192 Motor/Neurocognitive, CR (Cognitive Reconnaissance, read-side) \u2192 Cognitive/Psychotic, CD (Cognitive Disruption, write-side) \u2192 Cognitive/Psychotic, CV (Consent Violation) \u2192 Mood/Trauma, NP (Neuroplasticity) \u2192 Persistent/Personality, RV (Reversibility) \u2192 Chronicity modifier. This structural correspondence between security metrics and diagnostic categories is a research observation that requires clinical validation.',
