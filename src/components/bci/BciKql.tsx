/**
 * BciKql — KLQ (Kevin's Landscape Query) UI component.
 *
 * Query engine logic lives in src/lib/kql-engine.ts.
 * This file is UI-only: input, presets, result table, formatting, badges.
 */
...
const PRESETS: Array<{ label: string; query: string; group?: string }> = [
  ...
  // Neuroscience Deep
  { label: 'Cranial nerves', query: 'cranial_nerves | sort by number asc', group: 'neurosci' },
  { label: 'BCI-active nerves', query: 'cranial_nerves | where bci_relevance == "HIGH" | project name, type, functions, bci_relevance', group: 'neurosci' },
  { label: 'Neuroendocrine axes', query: 'neuroendocrine_axes', group: 'neurosci' },
  { label: 'Glial cells', query: 'glial_cells', group: 'neurosci' },
  { label: 'BBB proteins', query: 'bbb | sort by category asc', group: 'neurosci' },
  { label: 'BBB transporters', query: 'bbb | where category == "transporter"', group: 'neurosci' },
  { label: 'Meningeal system', query: 'meningeal_system', group: 'neurosci' },
  { label: 'Receptor families', query: 'receptor_families | sort by name asc', group: 'neurosci' },
  { label: 'Receptor subunits', query: 'receptor_subunits | sort by family asc', group: 'neurosci' },
  { label: 'Ionotropic receptors', query: 'receptor_families | where signaling contains "ionotropic"', group: 'neurosci' },
  { label: 'GPCR receptors', query: 'receptor_families | where signaling contains "GPCR"', group: 'neurosci' },
  { label: 'Neural pathways', query: 'neural_pathways | sort by bci_relevance desc', group: 'neurosci' },
  { label: 'Dopamine pathways', query: 'neural_pathways | where neurotransmitter == "dopamine"', group: 'neurosci' },
  { label: 'Neurotransmitters', query: 'neurotransmitters | sort by name asc', group: 'neurosci' },
...
// Engine functions imported from ../../lib/kql-engine
