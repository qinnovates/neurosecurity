 ...
 *
 * Structured data powering the convergence gap analysis on /governance/rights/
...
export const CONVERGENCE_GAPS: ConvergenceGap[] = [
  ...
  },
  {
    ...
    qifSolution: 'TARA provides 165 BCI techniques across 16 tactics with MITRE-compatible IDs and dual-use therapeutic mappings.',
  },
  {
...
export const PREDECESSOR_RESEARCH: PredecessorResearch[] = [
  ...
  },
  {
    ...
    whatQifAdds: 'TARA extends from their CIA foundation to 165 techniques with NISS scoring, dual-use classification, and DSM-5-TR psychiatric impact mappings.',
  },
  {
    authors: 'Schroder',
    year: 2025,
