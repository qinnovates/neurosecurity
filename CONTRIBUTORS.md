...
## Kevin L. Qi
Lead researcher, architect, developer. Qinnovate.

## Claude Opus 4.6
AI co-developer. Anthropic.
...
## Kevin's Dog
Qinnovate's first service dog contributor. Pressed "Enter" and "3" during the initial build session, contributing to the guide dog detection pipeline in the most direct way possible — by being present while we built it for dogs like them.
